## Phase 19 - Test tuned models - identical architecture

In this phase, the models from the previous phase will be tested with the same architecture. 
The goal is to verify if the tuning of the models improved their performance.
