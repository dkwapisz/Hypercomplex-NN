## Phase 21 - Test permutation of color channels in HyperComplex models
...
are the best. **Base for permutation is [Y, U, V, 0].**
...
All 24 permutations of the color channels will be tested. Base for permutation is [Y, U, V, 0].
